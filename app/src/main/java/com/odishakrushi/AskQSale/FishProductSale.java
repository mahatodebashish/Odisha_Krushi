...
public class FishProductSale extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getString(R.string.Sale)+"/"+getString(R.string.Fishery));
            ...
            public void onClick(View view, final int position) {
                ...
                edit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent i = new Intent(FishProductSale.this, PopUpFish.class);//PopUpSaleAnimal
              ...
              /*  deleteButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        // showDeleteDialog();
                        Intent intentDelete=new Intent(FishProductSale.this, DeleteRecord.class);
    ...
    private void loadProductlist() {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET,
                //"http://demo.ratnatechnology.co.in/farmerapp/api/sales/getallsalesbyuserId?user_id="+user_id+"&product_type=Fish"+"&category_name=Fishery", Doubt
                Config.baseUrl+"sales/getallsalesbyuserId?user_id="+user_id+"&product_type=Fish"+"&category_name=Fishery",
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            if (message.contains(jsonObject.getString("message")))
                            {
                                ...
                                Alerter.create(FishProductSale.this)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.add) {
            ...
            intent.putExtra("PROD_NAME","Fish");
