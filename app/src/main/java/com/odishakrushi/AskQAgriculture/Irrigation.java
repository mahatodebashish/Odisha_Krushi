...
public class Irrigation extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // getSupportActionBar().setTitle("Agriculture/Irrigation");
        getSupportActionBar().setTitle(getString(R.string.agriculture)+"/"+getString(R.string.Irrigation));
        ...
        AndroidNetworking.post(url)
                ...
                .getAsString(new StringRequestListener() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(Irrigation.this, "Question Submitted Successfully", Toast.LENGTH_SHORT).show();
                        ...
                        handler.postDelayed(new Runnable() {
                          ...
                          public void run() {
                            //Do something after 100ms
                              Intent i = new Intent(Irrigation.this, NavDrawer.class);//
                    ...
                    public void onError(ANError error) {
                        // handle error
                        Toast.makeText(Irrigation.this, "Network Error", Toast.LENGTH_SHORT).show();
                    }
                });
    }
        ...
        builder.setItems(pic, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    case 0:
                        txt_complete.setText("");
                        Toast.makeText(Irrigation.this, "Capture Photo", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
                        startActivityForResult(intent, requestCode);
                        break;
                    case 1:
                        txt_complete.setText("");
                        Toast.makeText(Irrigation.this, "Pick Image from Gallery", Toast.LENGTH_SHORT).show();
                    ...
                    case 2:
                        txt_complete.setText("");
                        Toast.makeText(Irrigation.this, "Video Record", Toast.LENGTH_SHORT).show();
                    ...
                    case 3:
                        txt_complete.setText("");
                        Toast.makeText(Irrigation.this, "Pick Video from Gallery", Toast.LENGTH_SHORT).show();
                    ...
                    case 4:
                        txt_complete.setText("");
                        Toast.makeText(Irrigation.this, "Pick Audio from Gallery", Toast.LENGTH_SHORT).show();
