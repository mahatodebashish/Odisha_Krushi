...
public class CultivationPractise extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getString(R.string.agriculture)+"/"+getString(R.string.Cultivation_Practice));
        ...
        AndroidNetworking.post(url)
                ...
                .getAsString(new StringRequestListener() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(CultivationPractise.this, "Question Submitted Successfully", Toast.LENGTH_SHORT).show();
                        ...
                        handler.postDelayed(new Runnable() {
                          ...
                          public void run() {
                            //Do something after 100ms
                              Intent i = new Intent(CultivationPractise.this, NavDrawer.class);//
                    ...
                    public void onError(ANError error) {
                        // handle error
                        Toast.makeText(CultivationPractise.this, "Network Error", Toast.LENGTH_SHORT).show();
        ...
        builder.setItems(pic, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    case 0:
                        txt_complete.setText("");
                        Toast.makeText(CultivationPractise.this, "Capture Photo", Toast.LENGTH_SHORT).show();
                    ...
                    case 1:
                        txt_complete.setText("");
                        Toast.makeText(CultivationPractise.this, "Pick Image from Gallery", Toast.LENGTH_SHORT).show();
                    ...
                    case 2:
                        txt_complete.setText("");
                        Toast.makeText(CultivationPractise.this, "Video Record", Toast.LENGTH_SHORT).show();
                    ...
                    case 3:
                        txt_complete.setText("");
                        Toast.makeText(CultivationPractise.this, "Pick Video from Gallery", Toast.LENGTH_SHORT).show();
                    ...
                    case 4:
                        txt_complete.setText("");
                        Toast.makeText(CultivationPractise.this, "Pick Audio from Gallery", Toast.LENGTH_SHORT).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        else  if(this.requestCode == requestCode && resultCode == RESULT_OK)
        {
            ...
            try {
                ...
                str_filePath = getRealPathFromURI(cameraImageUri);
                file_path.setText(str_filePath);
                file=new File(str_filePath);  // getting image captured filepath  < ----------------------------------------

                previewImage.setImageURI(cameraImageUri);
                previewImage.setVisibility(View.VISIBLE);
                previewLayout.setVisibility(View.VISIBLE);
            } catch (Exception e) {
                e.printStackTrace();
