...
import com.odishakrushi.Adapter.AdapterFishForSale;
...
import com.odishakrushi.ExtensionOff_ViewQuestion.ViewQuestionDetail_ExtOff;
...
public class FishPurchase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getString(R.string.Purchase)+"/"+getString(R.string.Fish));
        ...
        /*Alerter.create(FishPurchase.this)
                .setTitle("Loading...")
                .show();*/
                ...
                call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (checkPermission(Manifest.permission.CALL_PHONE)) {
                            ...
                            ActivityCompat.requestPermissions(FishPurchase.this, new String[]{Manifest.permission.CALL_PHONE}, MAKE_CALL_PERMISSION_REQUEST_CODE);
                        }
    ...
    private void loadProductlist() {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET,
                //"http://demo.ratnatechnology.co.in/farmerapp/api/sales/getallsalesbyuserId?user_id="+user_id+"&product_type=Fish", Doubt
                Config.baseUrl+"sales/getallsalesbyuserId?user_id="+user_id+"&product_type=Fish",
