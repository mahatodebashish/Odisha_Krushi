...
import com.odishakrushi.ViewProfile.ViewProfileStudent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1=new Intent(NavDrawerStudentR.this,ProfilePic.class);
        ...
        displaySelectedScreen(R.id.knowledgebank);
    }
...
*/
      ...
      /*  Snackbar snackbar = Snackbar
        ...
        snackbar.show();*/
/*
        Alerter.create(NavDrawerStudentR.this)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            startActivity(new Intent(NavDrawerStudentR.this, AppTutorial.class));

        }
        if(id==R.id.editProfile)
        {
            startActivity(new Intent(NavDrawerStudentR.this,ViewProfileStudent.class));// EditProfileStudentResearcher
        }
        else if(id==R.id.changePassword)
        {
            startActivity(new Intent(NavDrawerStudentR.this, ChangePassword.class));//EditProfileFarmer.class));
...
/*
    ...
    public void loadAd(){
        ...
        btnknowMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!(largeBannerUrl.equals(""))){
                    ...
                    Toast.makeText(NavDrawerStudentR.this, largeBannerUrl, Toast.LENGTH_SHORT).show();
         ...
         */
        String str_zone_id=Preferences.getZone(NavDrawerStudentR.this);
        String str_group_id=Preferences.getGroupID(NavDrawerStudentR.this);
        Utils.getAd(NavDrawerStudentR.this,str_zone_id,str_group_id,goProDialogImage);
