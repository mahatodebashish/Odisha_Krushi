...
public class BusinessmanList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Alerter.create(BusinessmanList.this)
                .setTitle("Loading...")
                .show();
                ...
                call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (checkPermission(Manifest.permission.CALL_PHONE)) {
                            ...
                            ActivityCompat.requestPermissions(BusinessmanList.this, new String[]{Manifest.permission.CALL_PHONE}, MAKE_CALL_PERMISSION_REQUEST_CODE);
                        }
...
/*
                            ...
                            for(int i=0;i<array.length();i++)
                            {
                                ...
                                PurchaseAP item=new PurchaseAP(
                                        ...
                                        ,first_name,phone,village,photo_url,business_district_name,business_block_name,
                                        year_of_purchase,make,model,condition,image);
