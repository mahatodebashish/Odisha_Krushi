package com.odishakrushi.AskQSoilCW;
...
public class AskQSoilCW extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getString(R.string.ask_question)+"/"+getString(R.string.Soil_Conservation_And_Watershed));
    ...
    private void uploadWithoutFile() {
        ...
        AndroidNetworking.post(url)
                ...
                .addBodyParameter("category_id","5")
                .addBodyParameter("sub_category_id",null)
                ...
                .getAsString(new StringRequestListener() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(AskQSoilCW.this, "Question Submitted Successfully", Toast.LENGTH_SHORT).show();
                        ...
                        handler.postDelayed(new Runnable() {
                          ...
                          public void run() {
                            //Do something after 100ms
                              Intent i = new Intent(AskQSoilCW.this, NavDrawer.class);//
                    ...
                    public void onError(ANError error) {
                        // handle error
                        Toast.makeText(AskQSoilCW.this, "Network Error", Toast.LENGTH_SHORT).show();
                    }
                });
    }
...
//"http://demo.ratnatechnology.co.in/farmerapp/api/qna/setFarmerQna"
        AndroidNetworking.upload(url)
                ...
                .addMultipartParameter("category_id","5")
                .addMultipartParameter("sub_category_id",null)
        ...
        builder.setItems(pic, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    case 0:
                        txt_complete.setText("");
                        Toast.makeText(AskQSoilCW.this, "Capture Photo", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
                        startActivityForResult(intent, requestCode);
                        break;
                    case 1:
                        txt_complete.setText("");
                        Toast.makeText(AskQSoilCW.this, "Pick Image from Gallery", Toast.LENGTH_SHORT).show();
                    ...
                    case 2:
                        txt_complete.setText("");
                        Toast.makeText(AskQSoilCW.this, "Video Record", Toast.LENGTH_SHORT).show();
                    ...
                    case 3:
                        txt_complete.setText("");
                        Toast.makeText(AskQSoilCW.this, "Pick Video from Gallery", Toast.LENGTH_SHORT).show();
                    ...
                    case 4:
                        txt_complete.setText("");
                        Toast.makeText(AskQSoilCW.this, "Pick Audio from Gallery", Toast.LENGTH_SHORT).show();
