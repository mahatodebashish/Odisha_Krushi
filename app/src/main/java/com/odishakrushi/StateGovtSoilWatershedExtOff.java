...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getString(R.string.StateGovt)+" "+getString(R.string.Department)+" "+getString(R.string.Soil_Conservation_And_Watershed));
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET,
            ...
            public void onErrorResponse(VolleyError volleyError) {
              ...
              /*  Snackbar snackbar = Snackbar
                ...
                snackbar.show();*/
                Alerter.create(StateGovtSoilWatershedExtOff.this)
              ...
              /*  Snackbar snackbar = Snackbar
                ...
                new Handler().postDelayed(new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        {
                            Intent i = new Intent(StateGovtSoilWatershedExtOff.this, ProfilePic.class);//Login
