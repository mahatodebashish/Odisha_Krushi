...
public class EditProfileFarmer extends AppCompatActivity {
    ...
    int count=0;
    TextView txtGender,txtCaste,txtdistrict,txtblock,txtgp;
    ...
    String machine_name,last_crop_grown_in,area,soil_testing_done,crop,seed_seedling_variety,fertiliser_used,pesticide_used,fingerling_from,
            machines_used,covered_by_insuarnce,loan_taken,fishery_activity,area_of_pond_acres,area_of_pond_own_lease,
        ...
        rgMachineTool.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (null != rb && checkedId > -1) {
                    ...
                    Toast.makeText(EditProfileFarmer.this, str_machinetool_use_yes_no, Toast.LENGTH_SHORT).show();
        ...
        CheckBoxGroup<String> checkBoxGroup = new CheckBoxGroup<>(checkBoxMap,
                new CheckBoxGroup.CheckedChangeListener<String>() {
                    ...
                    public void onCheckedChange(ArrayList<String> values) {
                        ...
                        Toast.makeText(EditProfileFarmer.this,str_animal_type,Toast.LENGTH_LONG).show();
                    }
        ...
        CheckBoxGroup<String> checkBoxGroup2 = new CheckBoxGroup<>(checkBoxMap2,
                new CheckBoxGroup.CheckedChangeListener<String>() {
                    ...
                    public void onCheckedChange(ArrayList<String> values2) {
                        ...
                        Toast.makeText(EditProfileFarmer.this,str_machines,Toast.LENGTH_LONG).show();
                    }
                    ...
                    public void onResponse(String getresponse) {
                        ...
                        try {
                            ...
                            for(int i=0;i<array.length();i++) {
                                ...
                                //txtdistrict.setText(districtid);


                                blockid = o.getString("block");
                                parseBlock(blockid);
                              //  txtblock.setText(blockid);
                              ...
                              //  txtgp.setText(gpid);
                                ...
                                if(fathers_name.equalsIgnoreCase("NULL"))
                                    fathername.setText("--");
                                else
                                fathername.setText(fathers_name);

                                input_mob_no.setText(phone);
                                input_mob_no.setFocusable(false);
                                ...
                                else if(irrigation_source.equals("LI Point"))
...
/*
    ...
    /**
     * here goes the gp get and set
     * */
    public void parseGp(String gpid)
    {
        String jsonGp = null;
        try {
            InputStream is = getAssets().open("gp.json");
            int size = is.available();
            byte[] buffer = new byte[size];
            is.read(buffer);
            is.close();
            jsonGp = new String(buffer, "UTF-8");
        } catch (IOException ex) {
            ex.printStackTrace();

        }
        System.out.print(jsonGp);


        try {

            JSONArray jsonArray=new JSONArray(jsonGp);

            String id="",name="",block_id="";
            for(int i=0;i<jsonArray.length();i++)
            {
                JSONObject jsonObject=jsonArray.getJSONObject(i);
                id=jsonObject.getString("id");
                name=jsonObject.getString("name");
                block_id=jsonObject.getString("block_id");
    ...
    {
        String str_number_of_cows=no_of_cows.getText().toString();
        String str_no_of_goat=no_of_goat.getText().toString();
        String str_no_of_chick=no_of_chick.getText().toString();
        String str_no_of_other_animal=no_of_other_animal.getText().toString();

        str_number_of_cows=(Integer.parseInt(str_number_of_cows)>=1)?str_number_of_cows:"0";
        str_no_of_goat=(Integer.parseInt(str_no_of_goat)>=1)?str_no_of_goat:"0";
        str_no_of_chick=(Integer.parseInt(str_no_of_chick)>=1)?str_no_of_chick:"0";
        str_no_of_other_animal=(Integer.parseInt(str_no_of_other_animal)>=1)?str_no_of_other_animal:"0";

        animal_numbers=str_number_of_cows+","+str_no_of_goat+","+str_no_of_chick+","+str_no_of_other_animal;
        ...
        new EditProfileFarmer.AsyncEditProfileFarmer().execute();
    }
    ...
    private  class AsyncEditProfileFarmer extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(EditProfileFarmer.this);
        ...
        protected Void  doInBackground(Void... params) {
            ...
            cred.add(new BasicNameValuePair("gender",txtGender.getText().toString())); //str_gender
            cred.add(new BasicNameValuePair("caste",txtCaste.getText().toString()));//str_caste

            cred.add(new BasicNameValuePair("irrigated_land_under_cultivation",iluc.getText().toString()));
            cred.add(new BasicNameValuePair("irrigation_source",str_irrisource));
            cred.add(new BasicNameValuePair("non_irrigated_land_under_cultivation",niluc.getText().toString()));
        ...
        protected void onPostExecute(Void result) {
            ...
            if(message.equals("Update Successfull"))
            {
             ...
             /*   Snackbar snackbar = Snackbar
                ...
                Alerter.create(EditProfileFarmer.this)
                        .setTitle(message)
                        .show();
                ...
                new Handler().postDelayed(new Runnable()
                {
                    ...
                    public void run()
                    {
                        /*Intent i = new Intent(EditProfileFarmer.this, NavDrawer.class);
                        startActivity(i);*/
                        finish();
                    }
                }, TIME_OUT);
