...
public class StateGovtHortiExtOff extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getString(R.string.StateGovt)+" "+getString(R.string.Department)+" "+getString(R.string.Horticulture));
            ...
            if(message.equals("Registration Successfull")||message.equals("Update Successfull"))
            {
                ...
                new Handler().postDelayed(new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        {
                            Intent i = new Intent(StateGovtHortiExtOff.this, ProfilePic.class);//Login
