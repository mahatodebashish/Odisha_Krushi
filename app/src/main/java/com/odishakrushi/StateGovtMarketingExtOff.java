...
public class StateGovtMarketingExtOff extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getString(R.string.StateGovt)+" "+getString(R.string.Department)+" "+getString(R.string.Marketing));
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET,
            ...
            public void onErrorResponse(VolleyError volleyError) {
              ...
              /*  Snackbar snackbar = Snackbar
                ...
                snackbar.show();*/
                Alerter.create(StateGovtMarketingExtOff.this)
            ...
            if(message.equals("Registration Successfull")||message.equals("Update Successfull"))
            {
                ...
                new Handler().postDelayed(new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        {
                            Intent i = new Intent(StateGovtMarketingExtOff.this, ProfilePic.class);//Login
