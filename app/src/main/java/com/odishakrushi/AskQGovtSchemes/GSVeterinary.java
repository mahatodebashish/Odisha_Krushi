package com.odishakrushi.AskQGovtSchemes;
...
public class GSVeterinary extends AppCompatActivity {

    String url="";

    String str_subcategory="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gsveterinary);
        ...
        getSupportActionBar().setTitle(getString(R.string.ask_question)+"/"+getString(R.string.Govt_Schemes));
        ...
        if (bundle != null) {
            str_subcategory = bundle.getString("SUBCATEGORY");
        }
    ...
    private void uploadWithoutFile() {
        ...
        AndroidNetworking.post(url)
                ...
                .addBodyParameter("category_id","4")
                .addBodyParameter("sub_category_id",str_subcategory)
                .addBodyParameter("dropdown","No Tag")
                ...
                .getAsString(new StringRequestListener() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(GSVeterinary.this, "Question Submitted Successfully", Toast.LENGTH_SHORT).show();
                        ...
                        handler.postDelayed(new Runnable() {
                          ...
                          public void run() {
                            //Do something after 100ms
                              Intent i = new Intent(GSVeterinary.this, NavDrawer.class);//
                    ...
                    public void onError(ANError error) {
                        // handle error
                        Toast.makeText(GSVeterinary.this, "Network Error", Toast.LENGTH_SHORT).show();
                    }
                });
    }
...
//"http://demo.ratnatechnology.co.in/farmerapp/api/qna/setFarmerQna"
        AndroidNetworking.upload(url)
                ...
                .addMultipartParameter("category_id","4")
                .addMultipartParameter("sub_category_id",str_subcategory)
                .addMultipartParameter("dropdown","No Tag")
        ...
        builder.setItems(pic, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    case 0:
                        txt_complete.setText("");
                        Toast.makeText(GSVeterinary.this, "Capture Photo", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
                        startActivityForResult(intent, requestCode);
                        break;
                    case 1:
                        txt_complete.setText("");
                        Toast.makeText(GSVeterinary.this, "Pick Image from Gallery", Toast.LENGTH_SHORT).show();
                    ...
                    case 2:
                        txt_complete.setText("");
                        Toast.makeText(GSVeterinary.this, "Video Record", Toast.LENGTH_SHORT).show();
                    ...
                    case 3:
                        txt_complete.setText("");
                        Toast.makeText(GSVeterinary.this, "Pick Video from Gallery", Toast.LENGTH_SHORT).show();
                    ...
                    case 4:
                        txt_complete.setText("");
                        Toast.makeText(GSVeterinary.this, "Pick Audio from Gallery", Toast.LENGTH_SHORT).show();
